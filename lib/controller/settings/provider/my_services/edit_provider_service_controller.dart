...
import 'package:b2b_partenership/views/provider_profile/my_services/widgets/edit_provider_service_details_widget.dart';
import 'package:b2b_partenership/views/provider_profile/my_services/widgets/edit_provider_service_features_widget.dart';
  ...
  Future<void> _addNewServiceFeature() async {
    final response = await CustomRequest<ServiceFeatureModel>(
      ...
      data: {
        ...
        "feature_ar": enFeatureController.text,
