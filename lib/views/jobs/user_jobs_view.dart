...
import 'package:b2b_partenership/controller/jobs/user_jobs_controller.dart';
...
class UserJobsView extends StatelessWidget {
  const UserJobsView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<UserJobsController>(
      init: UserJobsController(),
      builder: (UserJobsController controller) {
        return Scaffold(
          appBar: AppBar(
            title: Text(
              "MY JOBS".tr,
                  ...
                  child: CustomScrollView(
                    slivers: [
                      ...
                      SliverPadding(
                        ...
                        sliver: GlobalSliverServerStatusWidget(
