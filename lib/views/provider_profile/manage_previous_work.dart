...
import 'package:b2b_partenership/widgets/provider_profile/manage_previous_work_widget.dart';
        ...
        builder: (controller) => CustomServerStatusWidget(
          ...
          child: Padding(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (BuildContext context, int index) => ManagePreviousWorkWidget(
